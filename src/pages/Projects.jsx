...
const Projects=()=>{
    return(
        <section className="max-xontainer p-20">
            ...
            <div className="mt-s flex flex-col gap-3 text-slate-500">
                <p>
                Although I have done plenty of projects 
                during my days ,the are the ones that i have
                 selected to show my abilities i've mentioned 
                </p>
            </div>
